...
def compute_tubular():
    ...
    deformable_model.set_processors([
        ...
        ComputeLaplacianCorrespondence(input_keys=('fixed_rectum',),
                                       centerline_keys=('fixed_centerline',),
                                       output_keys=('fixed_correspondence',),
                                       spacing_keys=('fixed_rectum_spacing',),
                                       dilate_centerline=False),
        ...
        #                      origin_keys=('fixed_rectum_origin', 'moving_rectum_origin',),
        #                      spacing_keys=('fixed_rectum_spacing', 'moving_rectum_spacing',)),
        CenterlineProjection(input_keys=('xpoly',),
                             centerline_keys=('fpoly_centerline',),
                             correspondence_keys=('fixed_correspondence',),
                             output_keys=('xpoly',),
                             origin_keys=('fixed_rectum_origin',),
                             spacing_keys=('fixed_rectum_spacing',)),
